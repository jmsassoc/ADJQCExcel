...
Option Explicit
Public intTopValue As Integer
Public strSaveFileName As String
Public strExportDate As String
Public goPackageOld As New DTS.Package
Public goPackage As DTS.Package2
Public strProjecWhere As String
Public Sub Main()
...
Set oCustomTask1 = oTask.CustomTask
        ...
        oCustomTask1.SQLStatement = oCustomTask1.SQLStatement & "`Workdate` DateTime , " & vbCrLf
...
Set oCustomTask2 = oTask.CustomTask
        ...
        oCustomTask2.SourceSQLStatement = oCustomTask2.SourceSQLStatement & "FROM         (SELECT     TOP " & intTopValue & " CreateDate AS Workdate, projectName AS Project, MailBox, Folder, Groups, ClaimNO as  ClaimID, AdjStatus, Remark, UserID" & vbCrLf
        oCustomTask2.SourceSQLStatement = oCustomTask2.SourceSQLStatement & "                       FROM          TblClaimManage" & vbCrLf
        oCustomTask2.SourceSQLStatement = oCustomTask2.SourceSQLStatement & "                       WHERE      (CreateDate >= '" & strExportDate & "') AND (CreateDate <= '" & strExportDate & "') AND (Deleted = 0) " & strProjecWhere & vbCrLf
